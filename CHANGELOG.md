...
- Creating a workflow file inside a **link** mapping's folder will be refused rather than minting a workflow. A link folder mirrors its n8n tag and is not a place to author; copying and moving into one were already refused, and creating was the one door left open. Specified now, enforced in a follow-up.
